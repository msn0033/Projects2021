...
namespace ERPv1.Areas.Store.Controllers
{
    ...
    public class UnitMeasuresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UnitMeasureName")] UnitMeasure unitMeasure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UnitMeasureName")] UnitMeasure unitMeasure)
        {
